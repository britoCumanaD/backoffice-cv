<template>
    <div class="auth-card-container">
        <div class="auth-card" >
            ...
            <img loading="lazy" :src="this.$page.props.config.logo" alt="logo" class="pt-4 px-8 mx-auto max-w-40 max-h-12"
                v-if="this.$page.props.config && this.$page.props.config.logo"
            >
            ...
            >
                ...
                <div class="flex flex-row items-center justify-center mt-4 py-6">
                    <button
                        class="
