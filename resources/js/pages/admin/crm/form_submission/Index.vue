                    ...
                    <table class="table table-hover table-striped w-full">
                        ...
                        >
                            <td>
                                ...
                                <div v-else-if="submission.contact && !submission.contact.name_with_title" >
                                    {{ submission.contact.email }}
                                </div>
                                <div v-else>
                                    <span>{{ submission.contact ? submission.contact.name_with_title : ''}}</span>
                                    <br>
                            ...
                            <td>
                                {{ submission.form ? submission.form.name : submission.form_id }}
                            </td>
                            <td>
