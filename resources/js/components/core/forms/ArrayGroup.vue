...
<script>
    ...
    export default {
        ...
        mounted() {
            try {
                if(this.select){
                    this.editableInputValue = this.inputValue.values ? this.inputValue.values : JSON.parse(this.inputValue)
                }else{
                    if (Array.isArray(this.inputValue) || Array.isArray(this.inputValue.values)) {
                        this.editableInputValue = _.clone(this.select ? this.inputValue.values : this.inputValue);
                    } else if ((this.inputValue && this.inputValue.length) || (this.inputValue.values && this.inputValue.values.length)) {
                        this.editableInputValue = this.select ? this.inputValue.values.split(',') : this.inputValue.split(',');
                    } else {
