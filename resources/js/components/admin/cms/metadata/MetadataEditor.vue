                ...
                >
                    <div class="mb-2">
                        <p class="flex flex-row font-medium items-baseline text-theme-base-contrast text-sm tracking-wider">
                            <span>Title </span>
                            <sup v-if="isRequiredMeta" class="text-theme-danger-contrast">*</sup>
                        </p>
                        <p class="text-sm text-theme-base-subtle-contrast">
