<template>
  <div>
    ...
    <div v-show="!hiddenCheck" class="bg-theme-base-subtle h-px my-6"></div>
    ...
    <div class="flex flex-col md:flex-row md:mt-2 md:space-x-4" v-show="false">
...
export default {
  ...
  methods: {
    ...
    checkUrlIsAvailable: _.debounce(function () {
      ...
      axios
        .get(this.$route("admin.api.cms.urls.available"), {
          params,
