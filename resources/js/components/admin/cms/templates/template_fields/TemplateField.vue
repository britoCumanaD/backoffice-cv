...
<script>
    ...
    import SelectSettings     from "./template_field_settings/SelectSettings";
    import ModulesCustomSettings from "./template_field_settings/ModulesCustomSettings";
            ...
            settingsComponent() {
                ...
                switch (this.editableTemplateField.type) {
                    ...
                    case 'select_backoffice' :
                        if(!this.editableTemplateField.settings.options)
                            this.editableTemplateField.settings = { options: [] }
