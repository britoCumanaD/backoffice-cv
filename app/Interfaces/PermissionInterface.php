...
class PermissionInterface
{
    ...
    const CREATE_CMS_PAGE  = 'create cms page';
    const DELETE_CMS_PAGE  = 'delete cms page';
    const EDIT_CMS_PAGE    = 'edit cms page';
    const VIEW_CMS_PAGE    = 'view cms page';
    ...
    const ALL_PERMISSIONS = [
        ...
        'cms_page' => [
            'create'    => self::CREATE_CMS_PAGE,
            'delete'    => self::DELETE_CMS_PAGE,
            'edit'      => self::EDIT_CMS_PAGE,
            'view'      => self::VIEW_CMS_PAGE,
        ],
        'cms_advanced' => [
